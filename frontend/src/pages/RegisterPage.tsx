    ...
    <div style={styles.page}>
      ...
      <aside style={styles.sidebar} className="auth-sidebar">
        <div style={styles.sidebarInner}>
          ...
          <p style={styles.sidebarSub}>
            Join thousands of legal professionals who save hours on document review every week.
          </p>
        </div>
      ...
      <main style={styles.panel}>
        <div style={styles.formBox}>
          ...
          <p style={styles.subtext}>Start analysing legal documents in minutes</p>
              ...
              <div style={styles.passwordWrapper}>
                <input
                  ...
                  style={{
                    ...styles.input,
                    paddingRight: "2.8rem",
                    borderColor: !passwordsMatch ? "#dc2626" : undefined,
                  }}
